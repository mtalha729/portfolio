        ...
        <div id="About" className="w-[100%] h-auto flex pt-10 flex-col md:flex-row ">
            <div className="w-[100%] h-auto flex justify-center md:justify-between bg-gray-100  flex-col md:flex-row">
                ...
                <div className="w-full md:w-[60%] h-auto flex  flex-col m-4 ">
                    ...
                    <div className="mt-2 flex justify-start md:justify-center font-sans md:text-lg  text-justify text-gray-900 p-2 md:p-0">I am a passionate Web Developer who enjoys turning ideas into interactive and user-friendly web experiences. My journey started with curiosity about how the internet works, which grew into a strong interest in building responsive and accessible applications. I currently specialize in modern frontend technologies like React.js and Tailwind CSS, focusing on clean design and smooth functionality. I enjoy solving logical problems, learning new tools, and continuously improving my skills. I am always motivated to take on new challenges that help me grow and create meaningful digital solutions. </div>
