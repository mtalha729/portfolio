        ...
        <div id="About" className="w-[100%] h-auto flex pt-10 flex-col md:flex-row ">
            <div className="w-[100%] h-auto flex justify-center md:justify-between bg-gray-100  flex-col md:flex-row">
                ...
                <div className="w-full md:w-[60%] h-auto flex  flex-col m-4 ">
                    ...
                    <div className="mt-2 flex justify-start md:justify-center font-sans md:text-lg  text-justify text-gray-900 p-2 md:p-0">I am a Web Developer with passion for turning lines of code into interactive reality. My Journey Started with a curiosity for how the internet works, which evolved into a career building responsive , accesible web apps. Currently, i am specializing in insert stack e.g React.js and Tailwind. i love solving logic puzzles and always looking for the next challenge to sharpen my skills. </div>
